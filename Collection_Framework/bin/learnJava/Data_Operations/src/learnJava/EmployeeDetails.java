...
/*****************************************************************************************************************************************************************************/
	...
	public void insert_data_into_employeeDataTable(Connection connection, String table_name, int ID,String employee_name, String city_name, int input_salary) 
	{
...
/***********************************************************************************************************************************************/
	...
	public void employeeDepartmentTable(Connection connection, String table_name) {
		...
		try {
			...
			// variable named 'query'
			String query = "create table " + table_name
					+ "(department_name varchar(20),employeeID int,role varchar(20),foreign key(employeeID)references employee(employeeID));";
	...
	// this is a function which is responsible for insertion of department details
			...
			public void insert_data_into_employeeDepartmentTable(Connection connection, String table_name,String input_department, int input_id, String input_role) {
